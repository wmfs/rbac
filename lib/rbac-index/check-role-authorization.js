...
function checkRoleAuthorization (userId, ownerId, roles, resourceType, resourceName, action, rbacIndex) {
  const requiredRoleList = getRequiredRoleList(resourceType, resourceName, action, rbacIndex)
